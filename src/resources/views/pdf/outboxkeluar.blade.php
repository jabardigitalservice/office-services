...
<page backtop="2mm" backbottom="14mm" backleft="10mm" backright="4mm">
    <!-- <page_header> -->
    <!-- Setting Header -->
    ...
    <div style="width: 100%; font-family: Arial; font-size: 12px; margin-left: 5px; margin-top: 0px;">
    ...
    <br>
    <br>
    <div style="margin-right:-5px ;margin-left:75px; line-height: 17px; font-family: Arial; font-size: 12px; text-align: justify;">
        {!! $draft->Konten; !!}
    </div>
    ...
    <table width="100%" style="font-family: Arial; font-size: 12px; line-height: 15px;">
        <tr>
            <td width="10%" valign="top">
                ...
                @empty
                    @php
                        $roleNmae  = ucwords(strtolower($carbonCopy->first()->RoleName));
                        $str = str_replace('Dan', 'dan', $roleNmae);
                        $str = str_replace('Uptd', 'UPTD', $str);
                        $str = str_replace('Dprd', 'DPRD', $str);
                    @endphp
